...
import { defaultSettings, useSettingsContext } from '../../../core/contexts/SettingsContext';
...
export const SettingsModal: React.FC<Props> = ({
  ...
  >
    ...
    <Modal.Footer>
      <Button
        variant='danger'
        onClick={() => window.confirm('Are yo shure?') && setSettings(cloneDeepJson(defaultSettings))}
